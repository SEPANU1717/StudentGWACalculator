...
export const Button: React.FC<ButtonProps> = ({
    ...
    const variantStyles = {
        ...
        danger: 'bg-red-500/10 hover:bg-red-500/20 active:bg-red-500/30 text-red-500',
        ghost: darkMode
            ? 'bg-transparent hover:bg-[#1a1a1a] active:bg-[#222] text-gray-400 hover:text-white'
            : 'bg-transparent hover:bg-gray-100 active:bg-gray-200 text-gray-500 hover:text-gray-900'
    };
