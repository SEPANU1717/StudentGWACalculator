      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-semibold text-gray-900 dark:text-white" suppressHydrationWarning>STI GWA</div>
              <div className="text-xs text-gray-500 dark:text-[#555]" suppressHydrationWarning>Student Grade Calculator</div>
            </div>
          </div>
          ...
          <nav className="flex flex-wrap items-center gap-4 justify-center" aria-label="Footer navigation">
            <a
              href="#features"
              className="text-sm hover:text-emerald-400 transition-colors text-gray-500 dark:text-[#555]"
            ...
            <a
              ...
              className="flex items-center gap-2 text-sm hover:text-emerald-400 transition-colors text-gray-500 dark:text-[#555]"
